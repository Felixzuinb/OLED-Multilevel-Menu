...
void OLED_W_SCL(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(I2C_SCL_GPIO_Port, I2C_SCL_Pin, (BitValue) ? GPIO_PIN_SET : GPIO_PIN_RESET);
...
void OLED_W_SDA(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(I2C_SDA_GPIO_Port, I2C_SDA_Pin, (BitValue) ? GPIO_PIN_SET : GPIO_PIN_RESET);
